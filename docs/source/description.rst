...
регистру, а приоритет записывается вместе со значением. Поэтому запись в б/д имеет вид: ключ - "some name", значение - "1Correct Name". Подробнее об этом в описании 
