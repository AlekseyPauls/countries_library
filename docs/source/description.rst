...
регистру избавляются от пунктуации (не входящей в названия стран и пробелов), а приоритет записывается вместе со значением. Поэтому запись в б/д имеет вид: ключ - "somename", 
